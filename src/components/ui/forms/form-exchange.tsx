...
import CountrySelect, { CountryType } from '../country-select/country-select';
...
import { fetchCurrencyConversionEvents, fetchCurrencyEvents, fetchCurrencyOneConversionEvents } from '../../../utils/requestCurrencyData';
...
function GridExample({country,  countryTwo, data, inputValue}: any) {
  // console.log(data)
